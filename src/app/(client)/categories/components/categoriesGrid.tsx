      ...
      <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
        {categories.map((category, index) => (
          <Link key={category._id} href={`/category/${category?.slug}`}>
            <div
              className="group relative h-full overflow-hidden rounded-2xl bg-card shadow-md hover:drop-shadow-2xl hover-effect hover:-translate-y-2 border border-border"
            ...
            >
              ...
              <div className="relative p-8">
                ...
                <div className="mx-auto mb-6 flex h-32 w-32 items-center justify-center rounded-2xl bg-linear-to-br from-primary/20 to-primary/5 transition-all duration-300 group-hover:scale-110 group-hover:rotate-3 shadow-sm group-hover:shadow-lg">
                  {category.image ? (
                    <Image
                ...
                {/* Category Name */}
                <h3 className="mb-2 text-center font-bold text-xl text-foreground group-hover:text-primary transition-colors duration-300">
                  {category.name}
                </h3>
