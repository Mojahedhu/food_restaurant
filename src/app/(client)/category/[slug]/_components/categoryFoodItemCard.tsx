  ...
  return (
    <Link href={`/food/${food.slug}`}>
      <div className="group relative h-full overflow-hidden rounded-2xl bg-card shadow-md hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border border-border">
        <div className="absolute inset-0 bg-linear-to-br from-primary/10 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-10 pointer-events-none" />
        <div className="absolute inset-0 -translate-x-full group-hover:translate-x-full transition-transform duration-1000 bg-linear-to-r from-transparent via-white/10 to-transparent z-10 pointer-events-none" />
        <div className="relative aspect-square overflow-hidden bg-muted shrink-0">
          {food.images && food.images[0] ? (
            ...
            <Utensils className="w-20 h-20 text-primary group-hover:scale-110 transition-transform duration-500" />
          )}
        </div>
