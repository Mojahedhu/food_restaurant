...
const SignUpPage = () => {
  ...
  return (
    <div className="h-screen flex justify-center items-center bg-linear-to-br from-primary/5 to-primary/10 px-4 py-8">
      <Card className="w-full max-w-md shadow-lg  max-h-[95vh] overflow-y-auto">
