            ...
            (users || []).map((user) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Edit Action Button */}
                  <TableCell className="text-right pr-4 flex justify-end gap-4">
                    <Button
                      variant="ghost"
                      size="icon"
                      onClick={() => setSelectedUser(user)}
                      className="h-8 w-8 text-muted-foreground hover:text-primary hover:bg-secondary/50 rounded-lg transition-colors cursor-pointer"
                      disabled={isPending}
                    >
