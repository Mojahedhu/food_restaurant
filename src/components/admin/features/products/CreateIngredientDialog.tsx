...
import { createIngredientAction } from "@/actions/admin-products";
import {
  Dialog,
  DialogContent,
  DialogDescription,
...
export function CreateIngredientDialog() {
  ...
  const handleSubmit = async (e: React.SubmitEvent<HTMLFormElement>) => {
    ...
    if (result.success) {
      toast.success("Ingredient option created successfully! 📐");
      setName("");
      setDescription("");
      setOrder("");
      setIsOpen(false);
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          <DialogTitle>Add Menu Ingredient Option</DialogTitle>
          <DialogDescription>
            Create a new reusable portion ingredient option.
          </DialogDescription>
        </DialogHeader>
        <form onSubmit={handleSubmit} className="space-y-4">
          {/* <div className="grid grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Input
                id="ingredient-name"
                placeholder="e.g. Onion, Tomato, Paneer, Chicken"
                value={name}
          ...
          <div className="space-y-2">
            <Label htmlFor="ingredient-desc">Description</Label>
            <Textarea
              id="ingredient-desc"
              placeholder="Brief ingredient details..."
              rows={3}
              value={description}
